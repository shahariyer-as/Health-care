          ...
          <Row>
            <Col md={4} sm={4} xs={12}>
              <ul className="social-icon d-flex">
                <li>
                  <Link to="/home">{fbIcon}</Link>
                </li>
                <li>
                  <Link to="/home">{twitIcon}</Link>
                </li>
                <li>
                  <Link to="/home">{pintrstIcon}</Link>
                </li>
                <li>
                  <Link to="/home">{instaIcon}</Link>
                </li>
              </ul>
            </Col>
            <Col md={8} sm={8} xs={12} className="login-signup text-end">
              <div className="login-signup-links">
                <Link to="/signup" className="after-effect">
                  Sign up
                </Link>
                {user?.email ? (
              ...
              <div className="loged-in-data">
                ...
                {user?.photoURL && (
                  <Link className="user-img-link" to="/home">
          ...
          <Row>
            <Navbar variant="light" collapseOnSelect expand="md">
              ...
              <Navbar.Collapse className="justify-content-end nav-menu">
                ...
                <Nav.Link activeStyle={activeLink} as={NavLink} to="/Services">
                  Services
                </Nav.Link>
                <Nav.Link
                ...
                <Nav.Link activeStyle={activeLink} as={NavLink} to="/contact">
                  Contact
                </Nav.Link>
              </Navbar.Collapse>
            </Navbar>
