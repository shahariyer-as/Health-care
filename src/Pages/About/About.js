...
import whyPeopleImg from '../../Images/About.jpg'
                        ...
                        <Col md={6} sm={6} xs={12}>
                            ...
                            <Container fluid>
                                <Row>
                                    <Col lg={6} md={12} sm={12} xs={12}>
                                        <div className="why-choose-list d-flex">
                                            <div className="why-choose-icon-1"></div>
                                    ...
                                    <Col lg={6} md={12} sm={12} xs={12}>
                                        <div className="why-choose-list d-flex">
                                            <div className="why-choose-icon-2"></div>
                                            <div className="why-choose-list-title">
                                ...
                                <Row>
                                    <Col lg={6} md={12} sm={12} xs={12}>
                                        <div className="why-choose-list d-flex">
                                            <div className="why-choose-icon-3"></div>
                                            <div className="why-choose-list-title">
                                    ...
                                    <Col lg={6} md={12} sm={12} xs={12}>
                                        <div className="why-choose-list d-flex">
                                            <div className="why-choose-icon-4"></div>
                                            <div className="why-choose-list-title">
